...
`tap-google-sheets` is a Singer tap for GoogleSheets.
...
```bash
pipx install git+https://github.com/ORG_NAME/tap-google-sheets.git@main
```
...
```
tap-google-sheets --about --format=markdown
```
-->
